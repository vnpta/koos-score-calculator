...
function generatePDF() {
  ...
  // Thêm tiêu đề với font Arial hỗ trợ Unicode (tiếng Việt)
  doc.setFont("Arial", "bold")
  doc.setFontSize(25)
  doc.setTextColor(0, 0, 0) // Đặt màu cho tiêu đề (đen)
  doc.text("KET QUA TINH DIEM KOOS", 105, 20, { align: "center" })

  // Thêm thông tin người dùng
  doc.setFontSize(15)
  doc.setFont("Arial", "normal")
  doc.setTextColor(0, 0, 0) // Màu đen cho thông tin người dùng
  ...
  doc.setFontSize(15)
  doc.setFont("Arial", "bold")
  doc.setTextColor(0, 51, 102) // Màu xanh đậm cho tiêu đề kết quả
  doc.text("KOOS SCORE:", 10, 70)

  // Thêm điểm số KOOS vào file PDF
  doc.setFont("Arial", "normal")
  doc.setTextColor(0, 0, 0) // Màu đen cho điểm số
